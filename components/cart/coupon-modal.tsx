...
// Define the Coupon type to include a start date
type Coupon = {
  id: number;
  code: string;
  title: string;
...
export function CouponModal({
  ...
  const appliedDiscountCode = cart?.discountCodes?.[0]?.code;
                  ...
                  <div className="max-h-80 space-y-4 overflow-y-auto">
                    {couponState.loading ? (
                      ...
                      couponState.coupons.map((coupon) => {
                        const isApplied = appliedDiscountCode === coupon.code;
                        return (
                          <div
                            key={coupon.id}
                          ...
                          >
                            ...
                            <div className="w-2/3 border-l-2 border-dashed border-blue-200 pl-4">
                              ...
                              <p className="mt-1 text-xs text-gray-400">
                                {coupon.startDate} - {coupon.expiry}
                              </p>
